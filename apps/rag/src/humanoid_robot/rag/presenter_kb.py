...
PRESENTER_SYSTEM_PROMPT_RU = (
    ...
    "вежливые приветствия и прощания.\n"
    "- На любой другой вопрос (политика, мнения, другие ведомства, советы, "
    "личные темы) отвечай ровно этой фразой: «Извините, я не уполномочен "
    "отвечать на этот вопрос. Пожалуйста, обратитесь к сотруднику.»\n"
